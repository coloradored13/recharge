...
export default function Sidebar() {
  ...
  return (
    ...
    >
      {/* Logo */}
      <div className="flex items-center h-16 px-4 border-b border-sage-100">
        <div className="flex items-center gap-3 min-w-0">
          ...
          {expanded && (
            <span className="font-display font-bold text-sage-800 text-lg whitespace-nowrap">
              Recharge
            </span>
          )}
        </div>
      ...
      <div className="border-t border-sage-100 p-3">
        <button
          className="flex items-center gap-3 w-full px-2 py-2 rounded-lg text-sage-500 hover:bg-sage-50 hover:text-sage-700 transition-colors"
          title="Sign out"
        >
